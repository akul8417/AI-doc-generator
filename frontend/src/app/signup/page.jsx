...
const SignupSchema = Yup.object().shape({
  ...
  password: Yup.string().required('Password is required')
    ...
    .matches(/[0-9]/, 'Must container a number')
    .matches(/[\W]/, 'Must container a special character'),
...
const Signup = () => {
  ...
  const signupForm = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
     ...
     // }, 1000);
    //  resetForm();//reset form after submission send the value to the backend
    ...
    .then((result) => {
      ...
      console.log(err);
      toast.error('Error registeringuser');
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button className='text-white'
                    type='button'
                    onClick={() => { setPasswordHidden(!passwordHidden) }}>toggle visibility </button>
                  <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                    <svg className="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                    </svg>
